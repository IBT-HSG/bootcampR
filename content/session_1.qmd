...
What does _Integer Division_ (line 6) and _Remainder_ (line 7) actually mean? 
Run these lines and try to find out while tweaking the numbers a little.
:::
...
What does _All arguments are coerced to a common type_ actually mean? Hint: use `class()` for `a` & `test`.
:::
