...
## {.scrollable} {background-image="https://github.com/IBT-HSG/bootcampR/blob/main/img/GUI.png?raw=true"}
...
- to _comment out_ code blocks you don't need currently.
...
Assume you have conducted a more complicated calculation than `13 %% 5` as a intermediate part of your analysis. In that case, you want to store the result instead of performing the calculation over and over again.
...
To inspect the objects you have just created you can _call_ them.
...
Where possible, avoid using names of special characters, existing functions and variables. Doing so will cause confusion for the readers of your code.
